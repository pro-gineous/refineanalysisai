...
<div class="p-4 sm:p-6">
    ...
    <div id="frameworks-wrapper">
        <!-- Card View -->
        <div id="card-view" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 mb-6">
            @if($frameworks->count() > 0)
                @foreach($frameworks as $framework)
                    <div class="bg-white overflow-hidden shadow-sm rounded-lg border border-gray-200 hover:shadow-md transition">
                        ...
                        <!-- Framework Card Body -->
                        <div class="px-4 py-3">
                            <div class="text-sm text-gray-700 mb-3 h-12 overflow-hidden">
                        ...
                        <div class="px-4 py-3 bg-gray-50 border-t border-gray-200 flex justify-between">
                            <button type="button" class="text-blue-600 hover:text-blue-800 text-sm font-medium framework-preview" data-id="{{ $framework->id }}">
                                Preview
                            </button>
                            <div class="space-x-3">
            ...
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                ...
                <div class="p-6">
                    ...
                    <div class="mt-6 flex justify-between">
                        <a href="#" id="modal-framework-edit" class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                            Edit Framework
                        </a>
                        <button type="button" id="close-preview-button" class="inline-flex justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-blue-700 bg-blue-100 hover:bg-blue-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                            Close
                        </button>
                    </div>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function openPreviewModal(frameworkId) {
                ...
                fetch(`/admin/frameworks/${frameworkId}/preview`)
                    .then(response => response.json())
                    .then(data => {
                        // Populate modal with framework data
                        document.getElementById('modal-framework-name').textContent = data.name;
                        ...
                        document.getElementById('modal-framework-version').textContent = data.version || '-';
                        document.getElementById('modal-framework-created').textContent = new Date(data.created_at).toLocaleDateString('en-US', {year: 'numeric', month: 'short', day: 'numeric'});
                        document.getElementById('modal-framework-projects').textContent = data.projects_count || '0';
