        ...
        <div class="p-6">
            <form action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data" id="userCreateForm">
                    ...
                    <div class="space-y-6">
                        <div class="bg-gray-50 rounded-lg p-5 border border-gray-100 shadow-sm">
                            ...
                            <div class="mt-6 border-t border-gray-200 pt-4">
                                <h5 class="text-sm font-medium text-gray-700 mb-3">Password</h5>
                                <div class="mb-4">
                                    ...
                                    <div class="mt-1 relative rounded-md shadow-sm">
                                        ...
                                        <input type="password" name="password" id="password" 
                                            class="pl-10 w-full rounded-md border-gray-300 @error('password') border-red-300 focus:border-red-500 focus:ring-red-500 @else focus:border-indigo-500 focus:ring-indigo-500 @enderror shadow-sm focus:ring focus:ring-opacity-50" required autocomplete="new-password">
                                    </div>
                                    @error('password')
                                        <p class="text-red-500 text-xs mt-1 flex items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="mt-1 relative rounded-md shadow-sm">
                                        ...
                                        <input type="password" name="password_confirmation" id="password_confirmation" 
                                            class="pl-10 w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" required autocomplete="new-password">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="flex items-center bg-white p-3 rounded-md border border-gray-200">
                                    <input type="checkbox" name="mark_verified" id="mark_verified" value="1" {{ old('mark_verified') ? 'checked' : '' }}
                                ...
                                <p class="text-xs text-gray-500 mt-1">If checked, the user's email will be marked as verified and they won't need to verify their email.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-8 pt-5 border-t border-gray-200 flex flex-col-reverse sm:flex-row justify-end gap-3">
                    <a href="{{ route('admin.users.index') }}" class="w-full sm:w-auto bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 flex justify-center items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
