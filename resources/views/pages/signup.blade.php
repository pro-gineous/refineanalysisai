    ...
    <div class="bg-white rounded-3xl overflow-hidden shadow-xl flex flex-col md:flex-row max-w-6xl w-full">
        ...
        <div class="w-full md:w-1/2 p-8 md:p-10">
            <div class="flex justify-between items-start mb-8">
                <div>
                    <h2 class="text-gray-800 text-lg font-medium">Welcome to <span class="text-[#1A8AFF] font-bold">Refine Analysis</span></h2>
                    <h1 class="text-[#1A8AFF] text-5xl font-bold mt-2">Sign up</h1>
                </div>
                <div class="text-right">
                    <p class="text-gray-500 text-sm">Have an Account?</p>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#1A8AFF]" placeholder="User name" required>
                    </div>
                    <div>
                        <label class="block text-gray-700 mb-2 font-medium">Contact Number</label>
                        <input type="text" name="contact_number" value="{{ old('contact_number') }}" class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#1A8AFF]" placeholder="Contact Number">
                    </div>
                </div>
