// AI Journey Visualizations
// Esta es una versión limpia y libre de errores del código de visualización para AI Journey
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function initializeVisualizations() {
        ...
        // Return if any essential element is missing
        if (!frameworkSelector || !generateProcessMapBtn || !generateDataModelBtn || !visualizationArea) {
            console.error('Some visualization elements are missing');
            return;
        }
        ...
        frameworkSelector.addEventListener('change', function() {
            ...
            console.log('Framework selected:', currentFramework);
            
            // Show the appropriate framework content
